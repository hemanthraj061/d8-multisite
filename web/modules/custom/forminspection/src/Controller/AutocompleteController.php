...
class AutocompleteController extends ControllerBase {
     ...
     */
    public function inspAutocomplete(Request $request) {
        $matches = array();
    ...
    public function manageAction() {
        ...
        $form = \Drupal::forminspectioner()->getForm('Drupal\forminspection\Form\ForminspectionForm');

//        $form['type']['#title_display'] = 'invisible';

        return [ '#theme' => 'forminspectiontheme',
            '#form' => $form,
            '#templatefields' => 'ss',
        ];
    }
